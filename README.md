<p align="center">
  <h1 align="center">PixiJS Game Studios</h1>
  <p align="center">
    Turn a single Claude Code session into a full game development studio.
    <br />
    48 agents. 37 workflows. One coordinated AI team.
    <br /><br />
    <em>A fork of <a href="https://github.com/Donchitos/Claude-Code-Game-Studios">Claude Code Game Studios</a> focused on building PWAs with PixiJS v8 and deploying to Fly.io.</em>
  </p>
</p>
...
<p align="center">
  ...
  <a href="https://ko-fi.com/donchitos"><img src="https://img.shields.io/badge/Ko--fi-Support%20the%20original%20author-ff5e5b?logo=ko-fi&logoColor=white" alt="Ko-fi — Support the original author"></a>
</p>
...
### Fork Focus: PixiJS PWAs on Fly.io

This fork is opinionated about the target platform:

- **Renderer**: [PixiJS v8](https://pixijs.com/8.x/) — WebGL2-first, WebGPU-ready 2D rendering
- **Language**: TypeScript with Vite as the build system
- **Distribution**: Progressive Web Apps (PWA) — installable, offline-capable, mobile-friendly
- **Hosting**: [Fly.io](https://fly.io) — containerized deployment close to players

The agent set, coding standards, and workflows are all tuned for this stack. Engine specialists for Godot, Unity, and Unreal are still present but the default path assumes PixiJS.
...
This fork targets **PixiJS v8** as the primary engine. The upstream engine specialists for Godot, Unity, and Unreal remain available.

| Engine | Lead Agent | Sub-Specialists |
|--------|-----------|-----------------|
| **PixiJS v8** *(default)* | `gameplay-programmer` | `engine-programmer`, `ui-programmer`, `technical-artist` |
...
1. **Clone or use as template**:
   ```bash
   git clone https://github.com/Donchitos/pixijs-game-studios.git my-game
   cd my-game
   ```
...
Hooks use POSIX-compatible patterns (`grep -E`, not `grep -P`) and include fallbacks for missing tools. Works on macOS, Linux, and Windows (Git Bash) without modification.

### Deployment Target

Games built with this template deploy to **[Fly.io](https://fly.io)** as containerized PWAs:

- Vite builds a static bundle
- A lightweight server (e.g., Caddy or nginx) serves the PWA with correct headers (`Cache-Control`, `Service-Worker-Allowed`)
- `fly deploy` ships the container to Fly's global edge network

## Upstream Project

This is a fork of **[Claude Code Game Studios](https://github.com/Donchitos/Claude-Code-Game-Studios)** by [@Donchitos](https://github.com/Donchitos). The upstream project supports Godot, Unity, and Unreal Engine and receives active updates — check it out if PixiJS isn't your target.

---

*This fork is under active development alongside the upstream project.*
